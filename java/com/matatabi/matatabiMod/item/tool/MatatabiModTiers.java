package com.matatabi.matatabiMod.item.tool;
...
public class MatatabiModTiers {
    ...
    static {
        TierSortingRegistry.registerTier(MATATABI,new ResourceLocation(MatatabiMod.MOD_ID
                ,"matatabi"), List.of(Tiers.NETHERITE),List.of());
    }
}
